...
ttk.Label(tab2, text="Welcome to Tab 2").pack(padx=20, pady=20)
...
lbl_lname1.grid(row=0, column=1)
lbl_SS1.grid(row=0, column=2)

txt_name1 = ttk.Entry(taxPayerFrame)
txt_lname1 = ttk.Entry(taxPayerFrame)
txt_SS1 = ttk.Entry(taxPayerFrame
                    )
txt_name1.grid(column=0, row=1)
txt_lname1.grid(row=1, column=1)
txt_SS1.grid(row=1, column=2)
...
lbl_lname2.grid(row=2, column=1)
lbl_SS2.grid(row=2, column=2)

txt_name2 = ttk.Entry(taxPayerFrame)
txt_lname2 = ttk.Entry(taxPayerFrame)
txt_SS2 = ttk.Entry(taxPayerFrame
                    )
txt_name2.grid(column=0, row=3)
txt_lname2.grid(row=3, column=1)
txt_SS2.grid(row=3, column=2)
...
lbl_state.grid(row=4, column=1)
lbl_zip.grid(row=4, column=2)
txt_city.grid(row=5, column=0)
