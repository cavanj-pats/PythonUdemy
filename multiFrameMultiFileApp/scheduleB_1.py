...
class ScheduleB_1(tk.Frame):
    def __init__(self, parent, controller):
        ...
        self.line4Data.grid(column=1, row=rows+3)
         ...
         ####################need to add a button to go to 
        self.btnPart2 = tk.Button(self.leftFrame, text="ScheduleB_2",
                                  command=lambda: controller.show_frame("ScheduleB_2"))
        self.btnPart2.grid(column=0, row=6)
